...
export default function Signup() {
  ...
  return (
    <div className="max-w-md mx-auto px-6 py-20">
      <h1 className="font-display text-3xl font-semibold mb-2">Start your catalog</h1>
      <p className="font-body text-sm text-ink/70 mb-8">
        Already have an account? <Link to="/login" className="text-rust underline">Log in</Link>
      </p>
